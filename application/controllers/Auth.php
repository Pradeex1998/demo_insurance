...
class Auth extends CI_Controller 
{
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if($result) { 
					...
					$admin_data = array(
						'admin_id' 		 => $result['id'],
						'name' 			 => $result['name'],
						'is_admin_login' => $result['role_id']==1?TRUE:FALSE,
						'agency_id' 	 => $result['agency_id'] ?? '0',
					);
					...
					redirect(base_url('admin/insurance/insurance_list/'), 'refresh');
					// if($result['user_role'] == 'agency') {
					// 	redirect(base_url('admin/insurance/insurance_list/'), 'refresh');
					// } else {
					// 	redirect(base_url('admin/agency/agency_list/'), 'refresh');
					// }
	...
	//-------------------------------------------------------------------------
	public function logout($last_dashboard = '') {
		// Add User Activity
