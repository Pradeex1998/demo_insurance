                ...
                <table id="dataTable" class="table table-bordered table-striped" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;">Net Premium (Sum)</th>
                            <th style="text-align: center;">Gross Premium (Sum)</th>
                            <th style="text-align: center;">Net Payout (Sum)</th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
...
<script>
    $(document).ready(function() {
        ...
        $('#datepicker, #agency_id').on('change', function() {
            table.ajax.reload();
        });
...
<script>
    function datatable(tableId) {
        return $('#' + tableId).DataTable({
            ...
            columnDefs: [
                ...
                { targets: [2, 3, 4], className: 'text-right text-nowrap' },
            ...
            ajax: {
                url: "<?= base_url('admin/reports/agentwise_consolidated_report_datatable_json') ?>",
                type: "POST",
                data: function(d) {
            ...
            footerCallback: function(row, data, start, end, display) {
                ...
                [2, 3, 4].forEach(function(colIndex) {
    ...
    $("#export_excel").click(function (event) {
        ...
        exportTableToExcel("dataTable", "agent_wise_consolidate_table");
    });
</script>