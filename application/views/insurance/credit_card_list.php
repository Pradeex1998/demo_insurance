...
<div class="row clearfix">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">    
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                <input type="text" name="bank" id="bank" class="form-control" required maxlength="255">
                        ...
                        <div class="row clearfix" style="margin-top: 15px;">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                <input type="text" name="name_on_card" id="name_on_card" class="form-control" required maxlength="255">
                        ...
                        <div class="row clearfix" style="margin-top: 15px;">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                <input type="text" name="last4" id="last4" class="form-control" maxlength="4">
    ...
    function datatable(tableId) {
        var table = $('#'+ tableId).DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('admin/master/credit_card_datatable_json') ?>",
                "type": "POST",
            },
        });
    }
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#rtoForm').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "<?= base_url('admin/master/submit_credit_card') ?>",
                    type: "POST",
                    dataType: 'json',
                    data: $(this).serialize(),
                    success: function(res) {
                        ...
                        if (res.status === '1') {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Success',
                                text: res.message || 'Credit Card saved successfully!',
                                timer: 2000,
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Error',
                                text: res.message || 'Failed to save Credit Card. Please try again.',
                                timer: 3000,
                    ...
                    error: function(xhr, status, error) {
                        ...
                        let errorMessage = 'Failed to save Credit Card. Please try again.';
            ...
            $(document).on('click', '.editBtn', function() {
                const id = $(this).data('id');
                $.ajax({
                    url: "<?= base_url('admin/master/get_credit_card_byid') ?>/" + id,
                    type: "GET",
                    ...
                    success: function(response) {
                        if (response.status === "1" && Array.isArray(response.data) && response.data.length > 0) {
                            ...
                            $('#bank').val(card.bank);
                            $('#name').val(card.name);
                            $('#name_on_card').val(card.name_on_card);
                            $('#last4').val(card.last4);
                            $('#status').val(card.status).change();
                            $('#rtoModal .modal-title').text('Edit Credit Card');
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Error',
                                text: 'Invalid Credit Card data received.',
                                timer: 2000,
                                showConfirmButton: false
                            });
                        }
                    ...
                    error: function() {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'Failed to fetch Credit Card details. Please try again.',
                            timer: 2000,
                            showConfirmButton: false
                        });
                    }
            ...
            $('.addBtn').on('click', function() {
                $('#id').val('');
                $('#rtoForm')[0].reset();
                $('#rtoModal .modal-title').text('Add Credit Card');
