...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <?php echo form_open(base_url('delete_account/check_user'), 'class="login-form" '); ?>
                    <div class="msg">Enter Your Mobile Number</div>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons">phone</i>
                        </span>
                        <div class="form-line">
                            <input type="text" maxlength="15" class="form-control" name="mobile_no"  placeholder="Mobile Number" required>
                        </div>
                    </div>
                    
                    <div class="row">
                        <div class="col-xs-12">
                            <input type="submit" name="submit" id="submit" class="btn btn-block btn-success waves-effect" value="Send OTP">
                        </div>
                    </div>
                <?php echo form_close(); ?>
            </div>
